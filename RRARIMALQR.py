...
def write_data(NumSys, R_value, version, avg_power, avg_state_cost, avg_action_cost,var_state, var_control, avg_aoi):
    ...
    f = open("calculatedInfo/RRARIMALQR/stat" + path_unique + ".txt", "a")
...
def save_data(systems_plant,u_cont, alpha_u, P_s, beta,version, R, NumSys ):
    ...
    with open(r'dump/RRARIMALQR/state_data_'+unique+'.pkl', 'wb') as f:
        pickle.dump(systems_plant, f)

    with open(r'dump/RRARIMALQR/action_data_'+unique+'.pkl', 'wb') as f:
        pickle.dump(u_cont, f)

    with open(r'dump/RRARIMALQR/schedule_alpha_data_'+unique+'.pkl', 'wb') as f:
        pickle.dump(alpha_u, f)

    with open(r'dump/RRARIMALQR/power_data_'+unique+'.pkl', 'wb') as f:
        pickle.dump(P_s, f)

    with open(r'dump/RRARIMALQR/beta_data_'+unique+'.pkl', 'wb') as f:
        pickle.dump(beta, f)
